...
Public Class Cls_Usuarios
    ...
    Public Function scom_Usuario_Save(ByVal ent As Ent_Usuario) As Boolean
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Scom_upt_Usuario"
        Try
            ...
            cmd.Parameters.Add("@c_usua_transforma", OleDbType.Integer).Value = ent.c_usua_transforma
        ...
        End Try
    End Function
    Public Function scom_UsuaPermiso_Save(ByVal ent As Ent_UsuaPermiso) As Boolean
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Scom_upt_UsuaPermiso"
        Try
            If Conex.State = ConnectionState.Closed Then
                Conex.Open()
            End If
    ...
    Public Function Get_Usuario_Datos(ByVal Cadena As String, ByVal vOpt As String) As DataTable
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Scom_Datos_Usuario"
    ...
    Public Function Get_UsuaPermiso_Datos(ByVal Cadena As String, ByVal vOpt As String) As DataTable
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Scom_Datos_UsuaPermiso"
