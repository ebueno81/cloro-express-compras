...
Public Class Cls_MnOQSerie
    ...
    Public Function Get_OQSerie_Datos(ByVal Cadena As String, ByVal vOpt As String) As DataTable
        ...
        cmd.CommandText = "Sp_Spro_Datos_OQSerie"
        ...
        Return Tabla
    End Function
    Public Function Get_Cargar_OQSerie_Cbo(ByVal Cadena As String, ByVal Combo1 As ComboBox)
        Combo1.Items.Clear()
        Combo1.DataSource = Get_OQSerie_Datos(Cadena, "DAT")
