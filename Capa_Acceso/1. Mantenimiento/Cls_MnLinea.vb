...
Public Class Cls_MnLinea
    ...
    Public Function set_Linea(ByVal ent As Ent_MnLinea) As String
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Scal_upt_Linea"
        ...
        Try
            ...
            cmd.Parameters.Add("@c_desc_linea", OleDbType.VarChar, 50).Value = ent.c_desc_linea
