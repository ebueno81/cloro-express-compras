...
Public Class Cls_MnSFamilia
    ...
    Public Function set_SFamilia(ByVal ent As Ent_MnSFamilia) As String
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Scal_upt_SubFamilia"
        ...
        Try
            ...
            cmd.Parameters.Add("@c_codi_sfamilia", OleDbType.VarChar, 3).Value = ent.c_codi_subfamilia
            cmd.Parameters.Add("@c_desc_sfamilia", OleDbType.VarChar, 50).Value = ent.c_desc_subfamilia
