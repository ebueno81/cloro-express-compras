...
Public Class Cls_MnTpoCambio
    ...
    Public Function scom_TpoCambio_Save(ByVal ent As Ent_TpoCambio) As Boolean
        ...
        End Try
    End Function
    Public Function scom_ActuMasivoTpoCambio_Save(ByVal c_fecha_inicio As String, ByVal c_fecha_final As String) As String
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Scom_upt_ActuTcCompras"
        Try
            If Conex.State = ConnectionState.Closed Then
                Conex.Open() ''322174
            End If
