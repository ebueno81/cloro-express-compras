...
Public Class Cls_MnMtMov
    ...
    Public Function set_MtMovIng(ByVal ent As Ent_MnMtMov) As String
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Scal_upt_MtMovIng"
        ...
        Try
            ...
            cmd.Parameters.Add("@c_opt_clie", OleDbType.Integer).Value = ent.c_opt_clie
    ...
    Public Function Get_MtMov_Datos(ByVal Cadena As String, ByVal vOpt As String) As DataTable
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Scal_Datos_MtMovIng"
