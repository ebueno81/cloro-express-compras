...
Public Class Cls_RetenCab
    ...
    Public Function Sca_RetenCab_Save(ByVal Ent As Ent_RetenCab, ByVal Emp As String) As String
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Scom_" & Emp & "_upt_RetenCab"
    ...
    Public Function Get_RetenCab_Datos(ByVal Cadena As String, ByVal vOpt As String, ByVal Emp As String) As DataTable
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Scom_Datos_RetenCab"
