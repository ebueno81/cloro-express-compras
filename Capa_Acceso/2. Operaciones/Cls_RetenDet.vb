...
Public Class Cls_RetenDet
    ...
    Public Function Sca_RetenDet_Save(ByVal Ent As Ent_RetenDet, ByVal Emp As String) As String
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Scom_" & Emp & "_upt_RetenDet"
        ...
        Try
            ...
            cmd.Parameters.Add("@c_correl_reten", OleDbType.VarChar, 8).Value = Ent.c_correl_reten
    ...
    Public Function Get_RetenDet_Datos(ByVal Cadena As String, ByVal vOpt As String, ByVal Emp As String) As DataTable
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Scom_Datos_RetenDet"
