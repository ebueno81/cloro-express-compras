...
Public Class Cls_DuasCab
    Dim Conexion As New Cls_Conexion
    Dim Conex As New OleDbConnection(Conexion.GetConexion_Sql)
    Dim cmd As New OleDbCommand
    Public Function Scom_DuasCab_SAVE(ByVal ent As Ent_DuasCab) As String
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Scom_upt_DuasCab"
        ...
        Try
            ...
            cmd.Parameters.Add("@c_serie_dua", OleDbType.VarChar, 10).Value = ent.c_serie_dua
            ...
            cmd.Parameters.Add("@c_imp_inaf", OleDbType.Decimal, 12, 2).Value = ent.c_imp_inaf
            cmd.Parameters.Add("@c_imp_afecto", OleDbType.Decimal, 12, 2).Value = ent.c_imp_afecto
    ...
    Public Function Get_DuasCab_Datos(ByVal Cadena As String, ByVal vOpt As String) As DataTable
        ...
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Scom_Datos_DuasCab"
