...
Public Class Neg_MnSeries
    Dim c_Series As New Cls_MnSeries
    Public Function set_Series_Save(ByVal c_Entidades As Ent_SeriesDoc, ByVal Emp As String)
        Return c_Series.Scom_Series_Save(c_Entidades, Emp)
    End Function
    ...
    Public Function get_Series_Cbo(ByVal Cadena As String, ByVal Combo As ComboBox, ByVal Emp As String)
        Return c_Series.Get_Cargar_Series_Cbo(Cadena, Combo, Emp)
    End Function
End Class
