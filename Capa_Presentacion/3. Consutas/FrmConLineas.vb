Public Class FrmConLineas
    ...
    Private Sub FrmConLineas_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load

    End Sub
    Public Sub Cargar_Grid(ByVal Cadena As String)
        Dgv01.DataSource = c_Neg_MnTblGral.get_TblGral_Datos(Cadena, "DGV")
        With Dgv01
            ...
            If .RowCount > 0 Then
                ...
                If fila > -1 Then
                    ...
                    If Val(TxtVar.Text) = 1 Then
                        ...
                        FrmMnArticulos.TxtTg.Text = .Rows(fila).Cells("Linea").Value
                    End If
                    Me.Close()
                End If
            End If
