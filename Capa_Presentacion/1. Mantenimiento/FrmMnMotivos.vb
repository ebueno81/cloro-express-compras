Public Class FrmMnMotivos
    ...
    Public Sub Cargar_Grid()
        Dgv01.DataSource = c_Neg_MnMtMov.get_MtMov_Datos(" order by c_codi_mt", "DGV")
        With Dgv01
            ...
            .Columns("c_opc_clie").Visible = False
        End With
    End Sub
    ...
    Private Sub Cancelar_Registro()
        With Dgv01
            .Size = New Size(496, 241) : .Location = New Point(2, 60)
    ...
    Private Sub Grabar_Motivo(ByVal cOpcion As String)
        With c_Ent_MnMtMov
            Dim c_opc_clie As Integer = 0
            If ChkOpc.Checked = True Then c_opc_clie = 1
            .c_codi_mt = TxtCod.Text
            .c_desc_mt = TxtDesc.Text
            .c_opt_clie = c_opc_clie
    ...
    Private Sub Nuevo_Registro()
        With Dgv01
            .Size = New Size(496, 219) : .Location = New Point(2, 83)
            BtnCerrar.Text = "&Cerrar" : BtnGrabar.Enabled = False : Pan01.Enabled = True
            TxtCod.Clear() : TxtDesc.Clear() : Pan01.Enabled = False : BtnGrabar.Enabled = True
            BtnCerrar.Text = "Cancelar" : TxtCod_Sunat.Enabled = True
        End With
    End Sub
    ' Editamos registro '
            ...
            If .RowCount > 0 Then
                ...
                If Fila > -1 Then
                    If Val(.Rows(Fila).Cells("c_anula_Reg").Value) = 0 Then
                        ...
                        TxtCod_Sunat.Text = .Rows(Fila).Cells("Sunat").Value.ToString
                        ' Validamos si trabaja con cliente '
                        If Val(.Rows(Fila).Cells("c_opc_clie").Value.ToString) = 1 Then
                            ChkOpc.Checked = True
                        Else
