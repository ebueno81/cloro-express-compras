Public Class FrmRetenConsul
    ...
    Private Sub BtnMostrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnMostrar.Click
        Call Cargar_Grid(" and P.c_desc_prov like '" & TxtBus.Text & "%' and R.c_fecha_emi>='" & DtpFec_Inicio.Text & _
    ...
    Private Sub Dgv01_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Dgv01.DoubleClick
        With Dgv01
            If .RowCount > 0 Then
                ...
                If Fila > -1 Then
                    FrmRetencion.Mostrar_Retenciones(" and c_nro_serie='" & .Rows(Fila).Cells("Nro.").Value & "' and c_nro_Reten='" & .Rows(Fila).Cells("Retencion").Value & "'")
                    Me.Close()
                End If
            End If
        End With
