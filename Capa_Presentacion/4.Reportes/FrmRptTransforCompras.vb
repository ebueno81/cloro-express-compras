Public Class FrmRptTransforCompras
    Private Sub BtnMostrar_Click(sender As Object, e As EventArgs) Handles BtnMostrar.Click
        Call CargarGrid()
    End Sub
    Public Sub CargarGrid()
        With Dgv01
            .DataSource = c_Neg_AlmTransforCab.get_RptTransformaCompras_Datos(DtpFec_Inicio.Text, DtpFec_Final.Text, TxtcodTg.Text, TxtCodCd.Text, TxtCodArt.Text, "DGV")
            .Columns("Fecha Compra").Width = 70
            .Columns("Factura").Width = 80
            .Columns("Proveedor").Width = 180
            .Columns("Articulo").Width = 260
            .Columns("Compra").Width = 60
            .Columns("Fecha Transforma.").Width = 80
            .Columns("Vale").Width = 60
            .Columns("%").Width = 40
            .Columns("Salida").Width = 80
            .Columns("Ingreso").Width = 80
            ' Alineacion '
            .Columns("Fecha Compra").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter
            .Columns("Factura").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter
            .Columns("Compra").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
    ...
    Private Sub CalcularTotales()
        With Dgv01
            ...
            For i = 0 To .RowCount - 1
                TotCompra = TotCompra + Val(.Rows(i).Cells("Compra").Value.ToString)
    ...
    Private Sub BtnImp_Click(sender As Object, e As EventArgs) Handles BtnImp.Click
        ...
        End If
        Titulo = "Reporte de Transformaciones Del: " & DtpFec_Inicio.Text & " Al: " & DtpFec_Final.Text & Articulo & " - [COMPRAS]"
        BtnMostrar_Click(Nothing, Nothing)

        FrmReportes.Close()
        FrmReportes.Reporte_TransformaCompras(Titulo)
    End Sub
    ...
    Private Sub BtnConArt_Click(sender As Object, e As EventArgs) Handles BtnConArt.Click
        FrmConScd.MdiParent = FrmMenu : FrmConScd.Show() : FrmConScd.TxtVar.Text = 10 : FrmConScd.TxtCod_Tg.Text = TxtcodTg.Text
