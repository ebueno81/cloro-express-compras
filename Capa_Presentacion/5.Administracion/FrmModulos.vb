Public Class FrmModulos
    Dim x As Integer = 0
    Private Sub FrmModulos_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub FrmModulos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call Cargar_Grid() : Call Validar_Permiso()
    End Sub
    'Metodo que nos permite validar los permisos por usuarios...
    Private Sub Validar_Permiso()
        With FrmMenu.Dgv01
            For i = 0 To .RowCount - 1
                If UCase(.Rows(i).Cells("c_nom_formu").Value.ToString) = "FRMMODULOS" Then
    ...
    Private Sub Nuevo_Registro()
        With Dgv01
            .Size = New Size(796, 371) : .Location = New Point(0, 83) : Pan01.Enabled = True
    ...
    Private Sub Cancela_Registro()
        With Dgv01
            .Size = New Size(796, 396) : .Location = New Point(0, 58) : Pan01.Enabled = False
            Call Limpiar_Texto(Pan01) : Pan02.Enabled = True : BtnCerrar.Text = "&Cerrar"
            Pan03.Enabled = True : Dgv01.Enabled = True : BtnNuevo.Focus() : x = 1
        End With
    End Sub
    'Editamos registros...
    ...
    Private Sub Grabar_Modulo(ByVal cOpcion As String)
        With c_Ent_Modulos
            ...
            Call Cargar_Grid()
            ' Validate if enabled false or is new '
            If TxtCodigo.Enabled = True Then
                Dgv01.CurrentCell = Dgv01.Rows(Dgv01.RowCount - 1).Cells(0)
            End If
        End With
    End Sub
    Private Sub TxtNom_Formu_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtNom_Formu.TextChanged
        ...
        If e.KeyCode = Keys.Enter Then
            If Len(TxtCodigo.Text) > 0 Then
                If Len(TxtTit_Menu.Text) > 0 Then
                    ...
                    If F = vbYes Then
                        Call Grabar_Modulo("ADD") ': MsgBox("Registro se grabo correctamente...", vbExclamation, Compañia)
                    End If
                Else
