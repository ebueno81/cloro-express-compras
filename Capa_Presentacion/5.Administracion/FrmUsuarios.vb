Public Class FrmUsuarios
    ...
    Public Sub Cargar_Grid(ByVal Cadena As String)
        With Dgv01
            .DataSource = c_Neg_Usuario.get_Usuario_Datos(" ", "DGV")
    ...
    End Sub
    ' Metodo para avanzar presionando la tecla enter '
    ...
    Private Sub Mostrar_Usuario(ByVal codigo As String)
        With c_Neg_Usuario.get_Usuario_Datos(" and c_codi_usua='" & codigo & "'", "DAT")
            If .Rows.Count > 0 Then
                ...
                End If
                If Val(.Rows(0)("c_usua_transforma").ToString) = 1 Then
                    ChkOpcTransforma.Checked = True
                Else
                    ChkOpcTransforma.Checked = False
                End If

                'Mostramos el area 
                CboArea.SelectedValue = .Rows(0)("c_codi_area").ToString
                'Activamos Modulos por Usuarios...
                With c_Neg_Usuario.get_UsuaPermiso_Datos(" and P.c_codi_usua='" & codigo & "' AND M.c_anula_reg=0 order by M.c_codi_modulo", "DAT")
                    If .Rows.Count > 0 Then
                        For i = 0 To .Rows.Count - 1
    ...
    Private Sub Nuevo_Registro()
        ...
        ChkOpcAdm.Checked = False : ChkOpcTransforma.Checked = False
    End Sub
        ...
        With Dgv01
            If .RowCount > 0 Then
                ...
                If Fila > -1 Then 'Validamos si registro se encuentra activo o esta anulado
                    ...
                    Else
                        MsgBox(" Registro no puede ser editado, se encuentra eliminado...  ", MsgBoxStyle.Critical, Compañia)
                    End If
                End If
            End If
        End With
    ...
    Private Sub Grabar_Usuario(ByVal cOpcion As String)
        With c_Ent_Usuarios
            Dim c_usua_admin As Integer = 0 : Dim c_usua_transforma As Integer = 0
            If ChkOpcAdm.Checked = True Then c_usua_admin = 1
            If ChkOpcTransforma.Checked = True Then c_usua_transforma = 1
            ...
            .c_usua_transforma = c_usua_transforma
            .c_obs = TxtObs.Text
